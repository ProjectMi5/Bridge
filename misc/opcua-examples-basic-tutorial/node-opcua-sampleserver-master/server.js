...
var default_xmlFile = "../../../node_modules/node-opcua/nodesets/Opc.Ua.NodeSet2.xml";
...
function construct_my_address_space(server) {
    ...
    server.nodeVariable2 = server.engine.addVariableInFolder("MyDevice", {
        nodeId: "ns=4;s=myvariabl2", // some opaque NodeId in namespace 4
    ...
    server.engine.createFolder("RootFolder", {browseName: "Furnace_1"});
    server.nodeVariable1 = server.engine.addVariableInFolder("Furnace_1", {
        nodeId: "ns=2;s=Furnace_1.Temperature", // some opaque NodeId in namespace 4
